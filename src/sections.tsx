        ...
        <div className="relative z-10 max-w-[690px]">
          ...
          <Reveal delay={0.14}>
            <p className="hero-lead">
              Поймёте механику рынка, научитесь оценивать лоты, избегать ошибок и зарабатывать на
          ...
          <Reveal>
            <div className="migtorg-pro-copy">
              ...
              <div className="migtorg-pro-text">
                <p>
                  Мы показываем, как устроен рынок, процесс принятия решений по лотам, оценку автомобилей,
                  расчёт ставки и способы снижения рисков при покупке.
                </p>
              </div>
            </div>
          </Reveal>
